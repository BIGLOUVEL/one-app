...
export default function PreLaunchPage() {
  ...
  // Triple-click on logo reveals admin input
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[#050505]">
      ...
      <div className="relative z-20 flex min-h-screen flex-col items-center justify-center px-6 py-16">
        ...
        {/* Admin bypass — shown only after triple-click on logo */}
        {showAdminInput && (
          <form
          ...
          >
            <input
              ...
              className={`h-9 w-48 rounded-lg border bg-black/40 px-3 text-center text-xs text-white/60 outline-none backdrop-blur-sm transition-all ${
                adminError
            ...
            />
            {adminError && (
              <p className="text-[10px] text-red-400/70">Wrong code</p>
            )}
          </form>
        )}
      </div>
      ...
      <div className="absolute bottom-6 left-0 right-0 z-20 flex justify-center">
        <p className="text-[11px] tracking-widest text-white/15 uppercase">
